...
const elements = {
    ...
    songList: document.querySelector('.song-list')
        ...
        // 歌曲列表功能
        elements.showList?.addEventListener('click', (e) => {
            e.stopPropagation();
        ...
        // 新增返回输入功能
        document.querySelector('.return-input').addEventListener('click', () => {
            // 清除缓存和状态
            localStorage.removeItem(STORAGE_KEY);
            audio.pause();
            playlist = [];
        ...
        // 事件监听
        elements.loadPlaylist.addEventListener('click', () => {
        ...
        audio.addEventListener('ended', () => elements.next.click());